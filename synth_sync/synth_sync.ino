...
const int MIN_BPM_TEMPO_REPEAT = 3;   // How many times we see a tempo before we consider it changed
const int SMOOTHNESS = 5;             // How many pulse lengths we keep to find an average
...
unsigned long last_bpm_up_time = 0;   // the last time the bpm input went HIGH
